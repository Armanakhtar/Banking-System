...
lbl_title=Label(win,text="Students Banking",bg='powder blue',fg='blue',font=('arial',60,'bold','underline'))
lbl_title.pack()
    ...
    def send_otp():
        ...
        if(row==None):
            ...
            if(row[0]==email):
                ...
                try:
                    con=gmail.GMail("armanakhtar297@gmail.com","<email password>")
                ...
                btn_verify.place(relx=.4,rely=.6)
